...
class PaymentView(View):
    ...
    def post(self, request, *args, **kwargs):
        try:
            ...
            messages.error(request, "Too many requests to Stripe")
            return redirect("/")

        except stripe.error.InvalidRequestError:
            messages.error(request, "Invalid Stripe parameters")
            return redirect("/")

        except stripe.error.AuthenticationError:
            messages.error(request, "Stripe authentication failed")
            return redirect("/")

        except stripe.error.APIConnectionError:
            messages.error(request, "Network error with Stripe")
            return redirect("/")

        except stripe.error.StripeError:
            messages.error(request, "Stripe error occurred")
            return redirect("/")

        except Exception:
            messages.error(request, "A serious error occurred")
            return redirect("/")
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            if form.is_valid():
                ...
                messages.warning(request, "Failed checkout. Please check your form.")
                return redirect('core:checkout')
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            try:
                ...
                messages.info(request, "Your refund request was received")
            except ObjectDoesNotExist:
